...
mvn --non-recursive scm:checkout -Dmodule.name=entity-extractor -DscmVersion=relation-svm -DscmVersionType=branch
cd entity-extractor
mvn -e clean install -Dmaven.test.skip=true
cd ..

mvn --non-recursive scm:checkout -Dmodule.name=relation-extractor -DscmVersion=svm -DscmVersionType=branch
